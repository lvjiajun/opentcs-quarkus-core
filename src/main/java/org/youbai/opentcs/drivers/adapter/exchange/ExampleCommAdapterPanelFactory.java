...
import org.youbai.opentcs.drivers.vehicle.management.VehicleCommAdapterPanelFactory;
...
public class ExampleCommAdapterPanelFactory
  ...
  public List<VehicleCommAdapterPanel> getPanelsFor(
    ...
    panels.add(componentsFactory.createControlPanel((ProcessModelTO) processModel,
                                                    servicePortal.getVehicleService()));
    panels.add(componentsFactory.createStatusPanel((ProcessModelTO) processModel,
                                                   servicePortal.getVehicleService()));
    return panels;
  }
