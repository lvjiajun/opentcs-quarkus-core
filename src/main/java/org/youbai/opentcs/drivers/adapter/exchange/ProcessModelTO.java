...
/**
 * A serializable representation of a {@link ProcessModel}.
...
public class ProcessModelTO
   ...
   * @return This
   */
  public ProcessModelTO setVehicleRef(TCSObjectReference<Vehicle> vehicleRef) {
   ...
   * @return This
   */
  public ProcessModelTO setCurrentState(
   ...
   * @return This
   */
  public ProcessModelTO setPreviousState(
   ...
   * @return This
   */
  public ProcessModelTO setLastOrderSent(
   ...
   * @return This
   */
  public ProcessModelTO setVehicleHost(String vehicleHost) {
   ...
   * @return This
   */
  public ProcessModelTO setVehiclePort(int vehiclePort) {
   ...
   * @return This
   */
  public ProcessModelTO setPeriodicStateRequestEnabled(boolean periodicStateRequestEnabled) {
   ...
   * @return This
   */
  public ProcessModelTO setStateRequestInterval(int stateRequestInterval) {
   ...
   * @return This
   */
  public ProcessModelTO setVehicleIdleTimeout(int vehicleIdleTimeout) {
   ...
   * @return This
   */
  public ProcessModelTO setVehicleIdle(boolean vehicleIdle) {
   ...
   * @return This
   */
  public ProcessModelTO setDisconnectingOnVehicleIdle(boolean disconnectingOnVehicleIdle) {
   ...
   * @return This
   */
  public ProcessModelTO setReconnectingOnConnectionLoss(boolean reconnectingOnConnectionLoss) {
   ...
   * @return This
   */
  public ProcessModelTO setReconnectDelay(int reconnectDelay) {
   ...
   * @return This
   */
  public ProcessModelTO setLoggingEnabled(boolean loggingEnabled) {
