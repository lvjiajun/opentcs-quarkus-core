...
import org.youbai.opentcs.drivers.adapter.ProcessModel;
import org.youbai.opentcs.drivers.adapter.exchange.commands.SendRequestCommand;
import org.youbai.opentcs.drivers.adapter.exchange.commands.SetDisconnectingOnVehicleIdleCommand;
import org.youbai.opentcs.drivers.adapter.exchange.commands.SetIdleTimeoutCommand;
import org.youbai.opentcs.drivers.adapter.exchange.commands.SetLoggingEnabledCommand;
import org.youbai.opentcs.drivers.adapter.exchange.commands.SetReconnectingOnConnectionLossCommand;
import org.youbai.opentcs.drivers.adapter.exchange.commands.SetVehicleHostCommand;
import org.youbai.opentcs.drivers.adapter.exchange.commands.SetVehiclePortCommand;
...
import org.youbai.opentcs.customizations.ServiceCallWrapper;
...
import org.youbai.opentcs.drivers.vehicle.management.VehicleCommAdapterPanel;
import org.youbai.opentcs.drivers.vehicle.management.VehicleProcessModelTO;
import org.youbai.opentcs.util.CallWrapper;
import org.youbai.opentcs.util.Comparators;
import org.youbai.opentcs.util.gui.StringListCellRenderer;
...
public class ControlPanel
  ...
  private void initGuiContent() {
    ...
    for (ProcessModel.Attribute attribute : ProcessModel.Attribute.values()) {
      processModelChange(attribute.name(), processModel);
    }
  }
  ...
  public void processModelChange(String attributeChanged, VehicleProcessModelTO newProcessModel) {
    if (!(newProcessModel instanceof ProcessModelTO)) {
      return;
    }
    ...
    else if (Objects.equals(attributeChanged, ProcessModel.Attribute.VEHICLE_HOST.name())) {
      updateVehicleHost(processModel.getVehicleHost());
    }
    else if (Objects.equals(attributeChanged, ProcessModel.Attribute.VEHICLE_PORT.name())) {
      updateVehiclePort(processModel.getVehiclePort());
    }
    else if (Objects.equals(attributeChanged,
                            ProcessModel.Attribute.VEHICLE_IDLE_TIMEOUT.name())) {
      updateVehicleTimeout(processModel.getVehicleIdleTimeout());
    }
    else if (Objects.equals(attributeChanged, ProcessModel.Attribute.VEHICLE_IDLE.name())) {
      updateVehicleIdle(processModel.isVehicleIdle());
    }
    else if (Objects.equals(attributeChanged,
                            ProcessModel.Attribute.DISCONNECTING_ON_IDLE.name())) {
      updateDisconnectingOnIdle(processModel.isDisconnectingOnVehicleIdle());
    }
    else if (Objects.equals(attributeChanged,
                            ProcessModel.Attribute.RECONNECTING_ON_CONNECTION_LOSS.name())) {
      updateReconnectingOnConnectionLoss(processModel.isReconnectingOnConnectionLoss());
    }
    else if (Objects.equals(attributeChanged, ProcessModel.Attribute.LAST_ORDER.name())) {
      updateLastOrder(processModel.getLastOrderSent(), processModel.isCommAdapterConnected());
    }
    else if (Objects.equals(attributeChanged,
                            ProcessModel.Attribute.LOGGING_ENABLED.name())) {
  ...
  private void initComponents() {
    ...
    connectedButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/youbai/opentcs/drivers/adapter/res/symbols/LEDGray.gif"))); // NOI18N
    connectedButton.setText(bundle.getString("AdapterConnected")); // NOI18N
    connectedButton.setBorderPainted(false);
    connectedButton.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/org/youbai/opentcs/drivers/adapter/res/symbols/LEDRed.gif"))); // NOI18N
    connectedButton.setDisabledSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/org/youbai/opentcs/drivers/adapter/res/symbols/LEDGreen.gif"))); // NOI18N
  ...
  activeButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/youbai/opentcs/drivers/adapter/res/symbols/LEDGray.gif"))); // NOI18N
  activeButton.setText(bundle.getString("ControlPanel.AdapterActive")); // NOI18N
  activeButton.setBorderPainted(false);
  activeButton.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/org/youbai/opentcs/drivers/adapter/res/symbols/LEDRed.gif"))); // NOI18N
  activeButton.setDisabledSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/org/youbai/opentcs/drivers/adapter/res/symbols/LEDGreen.gif"))); // NOI18N
  ...
  layout.setHorizontalGroup(
    ...
    .addGroup(layout.createSequentialGroup()
      ...
      .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        .addGroup(layout.createSequentialGroup()
          .addComponent(connectionSettingsPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 380, javax.swing.GroupLayout.PREFERRED_SIZE)
          .addGap(6, 6, 6)
          .addComponent(setOrderPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        .addComponent(repeatOrderPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
      .addGap(0, 0, 0))
  );
  ...
  private javax.swing.JComboBox<OrderRequest.OrderAction> actionComboBox;
  ...
  private javax.swing.Box.Filler setOrderPanelFiller;
