 ...
 */
package org.youbai.opentcs.virtualvehicle.inputcomponents;
 ...
 * text inputs using it's nested class {@link TextInputValidator
 * TextInputValidator}.
 *
...
public abstract class TextInputPanel
  ...
  /**
   * <p>
   * A {@link DocumentListener DocumentListener} that can be
   ...
   * </p>
   * @see TextInputPanel#setInputValid(boolean, Document)
   */
