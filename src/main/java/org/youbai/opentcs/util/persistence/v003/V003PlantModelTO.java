...
import org.youbai.opentcs.util.persistence.BasePlantModelTO;
...
public class V003PlantModelTO
  ...
  public static V003PlantModelTO fromXml(@Nonnull Reader reader)
    ...
    try {
      return (V003PlantModelTO) createUnmarshaller().unmarshal(reader);
    }
    catch (JAXBException | SAXException exc) {
  ...
  private static JAXBContext createContext()
    ...
    return JAXBContext.newInstance(V003PlantModelTO.class);
  }
