 ...
 */
package org.youbai.opentcs.util.persistence.v003;
...
import org.youbai.opentcs.util.persistence.v002.V002ModelParser;
import org.youbai.opentcs.util.persistence.v002.V002PlantModelTO;
...
public class V003ModelParser {
  ...
  private List<PropertyTO> convertProperties(
      List<org.youbai.opentcs.util.persistence.v002.PropertyTO> tos) {
    return tos.stream()
  ...
  private List<PointTO.OutgoingPath> convertOutgoingPaths(
      org.youbai.opentcs.util.persistence.v002.PointTO to) {
  ...
  private List<AllowedOperationTO> convertAllowedOperations(
      List<org.youbai.opentcs.util.persistence.v002.AllowedOperationTO> tos) {
    return tos.stream()
  ...
  private List<LocationTO.Link> convertLinks(org.youbai.opentcs.util.persistence.v002.LocationTO to) {
  ...
  private List<MemberTO> convertMembers(List<org.youbai.opentcs.util.persistence.v002.MemberTO> tos) {
    return tos.stream()
        .map(member -> {
  ...
  private List<VisualLayoutTO.ShapeLayoutElement> convertShapeLayoutElements(
      org.youbai.opentcs.util.persistence.v002.VisualLayoutTO to) {
