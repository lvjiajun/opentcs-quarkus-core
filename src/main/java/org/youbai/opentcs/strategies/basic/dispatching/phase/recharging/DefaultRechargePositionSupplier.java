...
public class DefaultRechargePositionSupplier
  ...
  public List<DriveOrder.Destination> findRechargeSequence(Vehicle vehicle) {
    ...
    String assignedRechargeLocationName = vehicle.getProperty(Dispatcher.PROPKEY_ASSIGNED_RECHARGE_LOCATION);
    ...
    String preferredRechargeLocationName = vehicle.getProperty(Dispatcher.PROPKEY_PREFERRED_RECHARGE_LOCATION);
    if (assignedRechargeLocationName != null) {
