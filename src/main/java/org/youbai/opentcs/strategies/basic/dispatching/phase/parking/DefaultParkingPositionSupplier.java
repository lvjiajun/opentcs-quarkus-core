...
public class DefaultParkingPositionSupplier
  ...
  public Optional<Point> findParkingPosition(final Vehicle vehicle) {
    ...
    String assignedParkingPosName = vehicle.getProperty(Dispatcher.PROPKEY_ASSIGNED_PARKING_POSITION);
    ...
    String preferredParkingPosName = vehicle.getProperty(Dispatcher.PROPKEY_PREFERRED_PARKING_POSITION);
