...
abstract class AllocatorCommand
   ...
   */
  private AllocatorCommand(int priority, Scheduler.Client client) {
  ...
  public static class AllocationsReleased
     ...
     */
    public AllocationsReleased(Scheduler.Client client, Set<TCSResource<?>> resources) {
      super(2, client);
  ...
  public static class CheckAllocationsPrepared
     ...
     */
    public CheckAllocationsPrepared(Scheduler.Client client, Set<TCSResource<?>> resources) {
      super(4, client);
      this.resources = requireNonNull(resources, "resources");
    }
  ...
  public static class Allocate
     ...
     */
    public Allocate(Scheduler.Client client, Set<TCSResource<?>> resources) {
      super(5, client);
      this.resources = requireNonNull(resources, "resources");
    }
