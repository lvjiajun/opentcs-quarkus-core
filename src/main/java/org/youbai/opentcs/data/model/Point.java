...
public class Point
  ...
  private Point(String name,
    ...
    this.incomingPaths = TCSObject.setWithoutNullValues(requireNonNull(incomingPaths, "incomingPaths"));
    this.outgoingPaths = TCSObject.setWithoutNullValues(requireNonNull(outgoingPaths, "outgoingPaths"));
    this.attachedLinks = TCSObject.setWithoutNullValues(requireNonNull(attachedLinks, "attachedLinks"));
