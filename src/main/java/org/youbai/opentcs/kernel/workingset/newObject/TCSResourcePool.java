...
public abstract class TCSResourcePool implements KernelPool{

    /**
     * This class's Logger.
     */
    private static final Logger LOG = LoggerFactory.getLogger(TCSResourcePool.class);
    /**
    ...
    private final RMap<String, TCSObject<?>> objectsByName;
    ...
    public TCSResourcePool(@SimpleEventBusAnnotation EventHandler eventHandler,
